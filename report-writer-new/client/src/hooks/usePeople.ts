...
export interface Person {
  ...
  birthdate: string;
  userId: number;
  originalDateFormat?: string; // Add the originalDateFormat property
}
...
export const usePeople = () => {
  ...
  // Add a new person
  const addPerson = async (personData: Omit<Person, 'id' | 'userId'>) => {
  ...
  const updatePerson = async (id: number, personData: Partial<Omit<Person, 'id' | 'userId'>>) => {
