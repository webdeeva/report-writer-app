...
const FinancialReportPage = () => {
    ...
    return (_jsx(FormLayout, { children: _jsxs("form", { onSubmit: handleSubmit, children: [_jsx(FormHeader, { title: "Financial Report", description: "Generate a detailed financial analysis based on the person's birth card, yearly spread, and position correlations." }), _jsxs(FormSection, { title: "Person Information", children: [_jsx(FormField, { label: "Select Person", required: true, error: errors.personId, children: _jsx(PersonSelect, { value: selectedPersonId, onChange: handlePersonSelect, placeholder: "Select a person", required: true }) }), selectedPerson && (_jsxs(_Fragment, { children: [_jsx(FormField, { label: "Birth Date", children: _jsx("p", { className: "text-gray-700", children: selectedPerson.originalDateFormat ||
                                            // Format without timezone conversion to avoid date shifting
                                            selectedPerson.birthdate.split('T')[0].split('-').reverse().join('/') }) }), _jsx(FormField, { label: "Calculated Age", children: _jsx("p", { className: "text-gray-700", children: calculatedAge }) }), _jsx(FormField, { label: "Custom Age (Optional)", helpText: "Use this to generate a report for a different age than the calculated one.", children: _jsx("input", { type: "number", min: "1", max: "100", value: customAge, onChange: handleCustomAgeChange, className: "form-input", placeholder: "Enter custom age" }) })] }))] }), _jsxs(FormSection, { title: "Financial Report Information", children: [_jsx("p", { className: "text-gray-700", children: "This report provides a detailed financial analysis based on the position correlations between cards in their natural positions versus their current positions in your yearly spread. It includes:" }), _jsxs("ul", { className: "list-disc pl-5 mt-2 text-gray-700", children: [_jsx("li", { children: "Investment opportunities based on your card positions" }), _jsx("li", { children: "Business growth areas aligned with your natural talents" }), _jsx("li", { children: "Financial challenges and strategies to overcome them" }), _jsx("li", { children: "Year-to-year financial outlook and action plan" })] })] }), _jsx(FormFooter, { primaryButton: _jsx("button", { type: "submit", className: "px-4 py-2 bg-primary text-white rounded-md hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed", disabled: generating || !selectedPersonId, children: generating ? 'Generating...' : 'Generate Financial Report' }), secondaryButton: _jsx("button", { type: "button", className: "px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2", onClick: () => navigate('/dashboard'), children: "Cancel" }) })] }) }));
};
