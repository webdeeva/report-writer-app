    ...
    <FormLayout>
      <form onSubmit={handleSubmit}>
        <FormHeader 
          ...
          description="Generate a detailed relationship analysis for singles based on the person's birth card, yearly spread, and position correlations."
        />
        ...
        <FormSection title="Singles Report Information">
          <p className="text-gray-700">
            This report provides a detailed relationship analysis for singles based on the position correlations between cards in their natural positions versus their current positions in your yearly spread. It includes:
          </p>
          <ul className="list-disc pl-5 mt-2 text-gray-700">
            <li>Emotional growth and relationship wisdom</li>
            <li>Relationship challenges and strategies to overcome them</li>
            <li>Heart card love opportunities and attraction strategies</li>
          </ul>
        </FormSection>
        ...
        <FormFooter
          primaryButton={
            ...
            >
              {generating ? 'Generating...' : 'Generate Singles Report'}
            </button>
          }
          secondaryButton={
            <button
