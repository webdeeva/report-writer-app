...
const ReportHistoryPage = () => {
    ...
    useEffect(() => {
        if (location.state) {
            const { generating, personName, reportType, error: navError } = location.state;
